...
export default function RemoveLiquidity() {
  ...
  const handleSelectCurrencyA = useCallback(
    ...
    [params.currencyIdA, params.currencyIdB, navigate],
  );
                  ...
                  <AutoColumn gap="10px">
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          <StyledInternalLink
                            to={`/remove/${currencyA === ETHER ? WETH[chainId].address : params.currencyIdA}/${
                              currencyB === ETHER ? WETH[chainId].address : params.currencyIdB
                            }`}
                          >
                            Receive WETH
                          </StyledInternalLink>
                          ...
                          <StyledInternalLink
                            to={`/remove/${
                              currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'ETH' : params.currencyIdA
                            }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'ETH' : params.currencyIdB}`}
                          >
                            Receive ETH
                          </StyledInternalLink>
                        ) : null}
